...
\hypersetup{
  pdftitle={Classification, Regression, and Clustering under Sensor Drift: A Reproducible Machine Learning Benchmark},
  pdfauthor={Douglas Felipe de Lima Silva},
  pdfsubject={Reproducible machine learning benchmark for gas sensor drift},
  pdfkeywords={gas sensor drift, machine learning, classification, regression, clustering, temporal generalization, distribution shift, reproducibility}
}
...
The source code, configuration files, tests, and scripts required to reproduce the analyses reported in this study are publicly available at \url{https://github.com/PesquisaDoug/gas-sensor-drift-ml-benchmark}. The FULL experimental results reported in this manuscript were generated from commit \texttt{5ca408022aa5e44fa286116629553cd44d8e2788}, using the experimental profile defined in \texttt{configs/experiment.yaml}. The software is archived as version 1.0.0 on Zenodo at DOI: 10.5281/zenodo.22820993 \cite{delimasilva2026software}. The generated experiment manifest records the experiment commit, package versions, profile parameters, and execution metadata. Detailed instructions for reproducing the QUICK and FULL workflows are provided in the repository README.
